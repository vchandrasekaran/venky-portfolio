...
const attributeGroups = [
  ...
  },
  {
    label: 'AI workflows',
    score: 87,
    details: ['Text-to-SQL', 'Site assistant', 'Product apps']
  },
  {
    label: 'Sports-tech',
    score: 90,
    details: ['Cricket analytics', 'Paddle patent', 'Brand partnerships']
  }
]
          ...
          <div className="flex flex-col gap-5 bg-[radial-gradient(circle_at_top_right,rgba(56,189,248,0.16),transparent_34%),#10151d] p-6 md:p-8">
            <div>
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/12 pb-5">
                <div>
                  <p className="font-mono text-xs uppercase tracking-[0.24em] text-[#06b6d4]">Analytics details</p>
                ...
                <div className="flex h-28 w-28 shrink-0 items-center justify-center rounded-full p-1"
                  style={{ background: 'conic-gradient(#8b5cf6 0deg 326deg, rgba(255,255,255,0.1) 326deg 360deg)' }}
                >
