      ...
      <div className="container-max space-y-10 py-16">
        <header className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm text-white/70">
            Borrowing from the best of n8n and custom BI tooling: rapid visuals when experimenting, code when it counts,
            and obsessive observability once a workflow hits production.
          </p>
        </header>
