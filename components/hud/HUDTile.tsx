...
export default function HUDTile({ title, desc, href, tag }: { title: string; desc: string; href: string; tag?: string }){
  const inner = (
    <div className="relative h-32 rounded-2xl border border-white/10 bg-white/5 p-4 transition hover:border-[rgba(255,59,0,0.55)]">
      ...
      <span className="absolute right-4 top-4 text-[rgba(255,138,0,0.9)] opacity-0 transition group-hover:opacity-100">-&gt;</span>
