  ...
  return (
    <svg viewBox="0 0 120 120" className="h-full w-full" aria-hidden>
      ...
      <g transform={headTilt}>
        ...
        {/* head */}
        <path d="M30,72 C30,40 45,26 60,26 C75,26 90,40 90,72 C90,88 78,99 60,99 C42,99 30,88 30,72Z" fill="rgba(10,12,16,0.95)" stroke="rgba(255,59,0,0.5)" />
        {/* hair bun silhouette */}
        <circle cx="78" cy="30" r="10" fill="rgba(7,8,12,0.95)" stroke="rgba(255,59,0,0.4)" />
        {/* hair plate */}
        ...
        <path d="M44,64 C46,60 48,58 52,57" stroke="rgba(255,200,180,0.25)" />
        <path d="M76,64 C74,60 72,58 68,57" stroke="rgba(255,200,180,0.25)" />
        <path d="M46,74 C50,78 54,79 60,79 C66,79 70,78 74,74" stroke="rgba(255,200,180,0.18)" />
        ...
        <circle cx="88" cy="66" r="10" fill="rgba(10,12,16,0.9)" stroke="rgba(0,229,255,0.75)" strokeWidth="1.5" />
